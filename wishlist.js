...
let wishlisst=localStorage.getItem("wishlist")
        console.log(wishlisst)
        let wishlist=wishlisst!==null?JSON.parse(wishlisst):[]
        // console.log(wishlist.length)
        let pcontainer=document.getElementById("parentcontainer")
        let divgetting=document.getElementById("container")
       
        let backButton= document.getElementById("back-page")
        backButton.addEventListener("click",()=>{
            window.history.back()
        })
      
        let ClearWishList=document.getElementById("clearbtn")
        let clearwish_list=document.createElement("button")
        clearwish_list.setAttribute("class","clr-btn")
        clearwish_list.innerText="clear wishlist"
        clearwish_list.addEventListener("click",()=>{
            localStorage.removeItem("wishlist")
            divgetting.style.display="none"
        })
        pcontainer.appendChild(clearwish_list)

        wishlist.filter((val,ind,arr)=>{
        let cart_individual_container= document.createElement("div")
        cart_individual_container.setAttribute("class","Product-card")
        divgetting.appendChild(cart_individual_container)

        let cart_image_container=document.createElement("div")
        cart_image_container.setAttribute("class","image-container")
        ...
        cart_price.innerHTML=`RS.  <span class="price-color">${val.price}</span>`
        ...
        cart_individual_container.appendChild(product_rating)
        ...
        cart_individual_container.appendChild(seemorebtn)
        ...
        let addToCart=document.createElement("button")
            ...
            addToCart.addEventListener("click",()=>{
                ...
                cart.push(wishlist[ind])
                alert("Item added to cart")
               
                localStorage.setItem("add",JSON.stringify(cart))
            })
            cart_individual_container.appendChild(addToCart)
